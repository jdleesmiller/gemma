module Gemma
  #
  # Create tasks for generating `rdoc` API documentation with settings from the
  # gemspec.
  #
  ...
  class RDocPlugin < Plugin
    ...
    #
    # Name of file to display in index.html (the rdoc option --main); extracted
    ...
    #
    # Files to be processed by rdoc; extracted from gemspec; test files are not
    # included by default.
    #
    # @return [Array<String>] 
    #
    ...
    # the {#output}, {#main}, {#title} and {#template} options and the {#files}
    # list are handled separately.
    #
    # @return [Array<String>] 
    #

module Gemma
  ...
  #
  # This plugin is based on the `YARD::Rake::YardocTask` that comes bundled with
  # yard.  If you need an option that isn't exposed by the plugin, you can
  # modify the `YardocTask` object directly in a block passed to
  # {#with_yardoc_task}. 
  #
  class YardPlugin < Plugin
    #
    ...
    #
    # Name of file to display in index.html (the yard option --main); extracted
    # from gemspec; defaults to nil (none).
    #
    # @return [String, nil] 
    #
    attr_accessor :main
    ...
    #
    # Ruby files to be processed by yard; these are extracted from the gemspec;
    # test files are not included by default.
    #
    # @return [Array<String>] 
    #
    attr_accessor :files
    ...
    # docs are generated).
    #
    # @yield [yd] called after the defaults are set but before the yard task is
    # generated
    #
    ...
    # 
    # Options to be passed to yardoc; this includes {#options} and the {#main},
    # {#title} and {#output} options.
    #
    # @return [Array<String>]
    # 
